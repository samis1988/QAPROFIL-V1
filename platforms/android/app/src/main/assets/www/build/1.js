...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__watergater__ = __webpack_require__(824);
    ...
    WatergaterPage.prototype.addToCart = function () {
        if (this.color == null || this.width == null || this.thicknes == null || this.quantity == null || this.quantity < 0) {
            ...
            var data = {
                ...
                image: "assets/img/qaprofil/roof_pannel/water_gutter.png",
