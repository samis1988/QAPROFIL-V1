...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__roofpanels__ = __webpack_require__(823);
...
var RoofpanelsPage = /** @class */ (function () {
    function RoofpanelsPage(navCtrl, navParams, platform) {
        ...
        this.pages = [
            ...
            { title: 'Water Gutter', component: 'WatergaterPage', image: 'assets/img/qaprofil/roof_pannel/water_gutter11.png' }
        ];
    ...
    RoofpanelsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-roofpanels',template:/*ion-inline-start:"C:\Users\QAPROFIL\Desktop\QAPROFIL_mobile_aplication-main\src\pages\roofpanels\roofpanels.html"*/'<ion-header >\n  <ion-navbar color="primary" >\n          \n    <ion-title  face="Cambria" color="white">Roof Panels, Sheets</ion-title>\n           \n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n\n  <ion-list>\n    <ion-item *ngFor="let p of pages" (click)="goToSecond(p.component)">\n      <ion-thumbnail item-start>\n        <img src="{{p.image}}">\n      </ion-thumbnail>\n       <h2><b>{{p.title}}</b></h2> \n     <! ––  Roof Panels, Sheets ––>\n      <button ion-button outline item-end>View</button>\n    </ion-item>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"C:\Users\QAPROFIL\Desktop\QAPROFIL_mobile_aplication-main\src\pages\roofpanels\roofpanels.html"*/,
        }),
