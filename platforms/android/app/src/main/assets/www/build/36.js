...
var IndooralumPage = /** @class */ (function () {
    ...
    IndooralumPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-indooralum',template:/*ion-inline-start:"C:\Users\QAPROFIL\Desktop\QAPROFIL_mobile_aplication-main\src\pages\indooralum\indooralum.html"*/'<ion-header >\n  <ion-navbar color="primary" >\n          \n    <ion-title  face="Cambria" color="white">Indoor Aluminum False Ceilings</ion-title>\n           \n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n\n  <ion-list>\n    <ion-item *ngFor="let p of pages" (click)="goToSecond(p.component)">\n      <ion-thumbnail item-start>\n        <img src="{{p.image}}">\n      </ion-thumbnail>\n      <h2><b>{{p.title}}</b></h2>\n       \n      <button ion-button outline item-end>View</button>\n    </ion-item>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"C:\Users\QAPROFIL\Desktop\QAPROFIL_mobile_aplication-main\src\pages\indooralum\indooralum.html"*/,
        }),
