...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__gypsum__ = __webpack_require__(785);
...
var GypsumPage = /** @class */ (function () {
    ...
    GypsumPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-gypsum',template:/*ion-inline-start:"C:\Users\QAPROFIL\Desktop\QAPROFIL-V1\src\pages\gypsum\gypsum.html"*/' \n\n<ion-header >\n  <ion-navbar color="primary" >\n          \n    <ion-title  face="Cambria" color="white">Gypsum Ceilings & Partitions Systems</ion-title>\n          \n        \n  </ion-navbar>\n</ion-header>\n\n\n\n  <style>\n.masters {\n \n  /* background: url(\'assets/img/steel.jpg\') repeat ;*/\n  background-color: white;\n}\n \n</style>\n\n\n\n<ion-content>\n\n  <ion-list>\n    <ion-item *ngFor="let p of pages" (click)="goToSecond(p.component)">\n      <ion-thumbnail item-start>\n        <img src="{{p.image}}">\n      </ion-thumbnail>\n      <h2><b>{{p.title}}</b></h2>\n      \n      <button ion-button outline item-end><b>View</b></button>\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\Users\QAPROFIL\Desktop\QAPROFIL-V1\src\pages\gypsum\gypsum.html"*/,
        }),
